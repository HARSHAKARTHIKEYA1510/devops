      ...
      <div style={{ width: '100%', maxWidth: 440, position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ background: '#0a0a0a', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 24, padding: '2rem', boxShadow: '0 32px 64px rgba(0,0,0,0.4)' }}>
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            <div>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.4rem' }}>
                ...
                <a href="#" style={{ color: '#ffffff', fontSize: '0.8rem', textDecoration: 'none' }}>Forgot password?</a>
              </div>
          ...
          <div style={{ position: 'relative', margin: '1.5rem 0', textAlign: 'center' }}>
            ...
            <span style={{ position: 'relative', background: '#0a0a0a', padding: '0 0.75rem', color: 'rgba(255,255,255,0.35)', fontSize: '0.8rem' }}>or</span>
          </div>
        ...
        <p style={{ textAlign: 'center', marginTop: '1.5rem', color: 'rgba(255,255,255,0.4)', fontSize: '0.875rem' }}>
          ...
          <Link href="/auth/register" style={{ color: '#ffffff', textDecoration: 'none', fontWeight: 600 }}>Sign up free →</Link>
        </p>
      </div>
    </div>
  );
